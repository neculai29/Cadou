...
<head>
  ...
  <title>Surpriză pentru Ale</title>
  <style>
    body {
    ...
    #wait, #message, #gift-box, #gift-reveal {
      display: none;
    }
...
Au fost 4 luni cu suișuri și coborâșuri, dar, la finalul fiecărei zile, tot ajungem să vorbim și să râdem împreună.
